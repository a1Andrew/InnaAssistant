...
# Вбудований lower() у SQLite знає лише латиницю, тож «Оля» != «оля».
...
SYSTEM = """Ти — персональна асистентка-організатор. Твоя робота: тримати всі напрямки
життя й роботи власниці в одній системі та щодня складати з них зрозумілий пазл.
...
- Задачі інших людей завжди з assignee. Якщо щось висить на людині кілька днів —
  окремо це підсвічуй.
...
Відповідай тією мовою, якою пише власниця (російською — російською).
"""
...
TOPIC_PLAN = [
    ...
    ("work", "📋 Наша робота", "Наша робота",
     "Задачі команді й контроль виконання. Пиши: «Олі — договір до п'ятниці»."),
...
HELP = (
    ...
    "• «додай задачу Олі підготувати договір до п'ятниці»\n"
